...
/*
 * Change this class  to handle Oracle specific dataType (Number and Decimal)
 * 
 */
...
public class DataConverter {
  ...
  private static void addFieldSchema(ResultSetMetaData metadata, int col,
    ...
    //System.out.println("REPRESNT COLUMN TYPE : ALOK "+ sqlType);
...
//        }
//        //System.out.println("ALOK  " + fieldBuilder.type());
//    	  //builder.field(fieldName, Schema.INT32_SCHEMA);
...
//      }
      ...
      case Types.NUMERIC:
          ...
          if (metadata.getScale(col) == 0 && precision < 20) { 
            Schema schema;
            if (precision > 10) {
